...
$(document).on( 'pageinit', function(){  
	...
	$(".ui-input-search .ui-input-text").keyup(function(){
		...
		var request = '{"Service":"Scraper","Method":"search","Parameters":{"keyword": "'+keyword+'", "user_id": "'+$.session.get('rakeuser')+'"}}';
 ...
 $(document).ready(function(){  
	...
	*/
	...
	$('.scraper_settings_rate_select').change(function() {
		var new_value = $(this).val();
		var request = '{"Service":"Scraper","Method":"changePrivacy","Parameters":{"scraper_id": "'+$.session.get('rakescraper')+'", "privacy": "'+new_value+'"}}';
		$.post( api_url, {"data": request}, function( response ) {
			console.log( response.Status );
			console.log( response.Result ); 
		}, "json");
