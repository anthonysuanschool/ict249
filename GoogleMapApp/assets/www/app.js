...
function fetchDetails(entry) {
	...
	var detailsUrl = "https://maps.googleapis.com/maps/api/place/details/json?reference=" + entry.reference + "&sensor=true&key=AIzaSyCzUrRnoEC_Jfr8aMV0nHli1BwaT5SO_g4";
	$("#name").html("");
	$("#address").html("");
	$("#phone").html("");
	$("#rating").html("");
	...
	$("#search").click(function () {
		...
		try {
			...
			navigator.geolocation.getCurrentPosition(function (position) {
				...
				var url = "https://maps.googleapis.com/maps/api/place/search/json?location=" + position.coords.latitude + "," + position.coords.longitude + "&radius=" + radius + "&name=" + $("#searchbox").val() + "&sensor=true&key=AIzaSyCzUrRnoEC_Jfr8aMV0nHli1BwaT5SO_g4";
